            ...
            <div class="row">
                <div class="col-lg-12">      
                    <div class="card card-primary">
                        <!-- form start -->
                        <form action="{{ route('ageframe.store') }}" method="POST">
                        @csrf
                        <div class="card-body">
                          ...
                          <div class="form-group">
                            ...
                            <select name="model_id" class="form-control" required>
                                @foreach ($car_models as $car_model)
                                    <option value="{{ $car_model['id'] }}">{{ DB::table('brands_frames')->where('id', DB::table('car_models_frames')->where('id', $car_model['id'])->value('brand_id') )->value('name') }} {{ $car_model['name'] }}</option>
                                @endforeach
                            </select>
                          </div>
                          <div class="form-group">
