            ...
            <div class="row">
                <div class="col-lg-12">      
                    <div class="card card-primary">
                        <!-- form start -->
                        <form action="{{ route('age.update', $age['id']) }}" method="POST">
                        @csrf
                        @method('PUT')
                        <div class="card-body">
                          <div class="form-group">
                            <label for="InputUrl">URL</label>
                            <input id="InputUrl" value="{{ $age['url'] }}" maxlength="250" class="form-control" type="text" name="url" placeholder="Введите url" required>
                          </div>
                          <div class="form-group">
                            <label for="InputTitle">Title</label>
                            <input id="InputTitle" value="{{ $age['title'] }}" maxlength="250" class="form-control" type="text" name="title" placeholder="Введите title" required>
                          </div>
                          <div class="form-group">
                            <label for="InputDescription">Description</label>
                            <input id="InputDescription" value="{{ $age['description'] }}" maxlength="250" class="form-control" type="text" name="description" placeholder="Введите Description" required>
                          </div>
                          <div class="form-group">
                            <label for="InputH1">H1</label>
                            <input id="InputH1" value="{{ $age['h1'] }}" maxlength="250" class="form-control" type="text" name="h1" placeholder="Введите загаловок H1" required>
                          </div>
                          <div class="form-group">
                            <label for="InputSubtitle">Текст под заголовком</label>
                            <input id="InputSubtitle" value="{{ $age['subtitle'] }}" maxlength="250" class="form-control" type="text" name="subtitle" placeholder="Введите загаловок текст под заголовком" required>
                          </div>
                          <div class="form-group">
                            <label for="InputName">Название поколения</label>
                            <input type="text" value="{{ $age['name'] }}" maxlength="250" name="name" id="InputName" class="form-control" placeholder="Введите отображаемое название поколения" required>
                          </div>
                          <div class="form-group">
                            <label>Модель</label>
                            <select name="model_id" class="form-control" required>
                                @foreach ($car_models as $car_model)
                                    ...
                                    @if($age['model_id'] == $car_model['id']) selected @endif>{{ DB::table('brands')->where('id', DB::table('car_models')->where('id', $car_model['id'])->value('brand_id') )->value('name') }} {{ $car_model['name'] }}</option>
                                @endforeach
                            </select>
                          </div>
                          <div class="form-group">
                            <label for="feature_image">Картинка</label>
                            <img src="{{url('/')}}/{{$age['img']}}" alt="" class="img-uploaded" style="display: block; max-height: 250px; width: auto; margin: 10px">
                            <input type="text" name="img" class="form-control" id="feature_image" value="{{ $age['img'] }}" readonly required>
                        ...
                        <div class="form-group">
                          ...
                          <textarea name="options[1][parameter1][value]" class="editor">{{ $age['options']['1']['parameter1']['value'] }}</textarea>
                        </div>
                        <!-- parameter 2-->
                        <div class="form-group">
                          ...
                          <textarea name="options[2][parameter2][value]" class="editor">{{ $age['options']['2']['parameter2']['value'] }}</textarea>
                        </div>
                        <!-- parameter 3-->
                        <div class="form-group">
                          ...
                          <textarea name="options[3][parameter3][value]" class="editor">{{ $age['options']['3']['parameter3']['value'] }}</textarea>
                        </div>
                        <!-- parameter 4-->
                        <div class="form-group">
                          ...
                          <textarea name="options[4][parameter4][value]" class="editor">{{ $age['options']['4']['parameter4']['value'] }}</textarea>
                        </div>
                        <!-- parameter 5-->
                        <div class="form-group">
                          <label>Контент</label>
                          ...
                          <textarea name="options[5][parameter5][value]" class="editor">{{ $age['options']['5']['parameter5']['value'] }}</textarea>
                        </div>
                        <!-- question-list -->
