...
@section('content')    
    ...
    <article>
        <div class="article_content">
            <h1>{{$h1}}</h1>
            <h2>{{$video['title']}}</h2>
            <div class="page_install__video">
                <iframe width="564" height="278" src="{{$video['link']}}" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
            </div>
            {!!$content!!}
        </div>
