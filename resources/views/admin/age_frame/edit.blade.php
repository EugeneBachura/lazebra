...
@section('title', 'Редактировать поколение')
...
@section('content')
    ...
    <div class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              <h1 class="m-0">Редактировать поколение</h1>
            </div><!-- /.col -->
          </div><!-- /.row -->
        </div><!-- /.container-fluid -->
      </div>
            ...
            <div class="row">
                <div class="col-lg-12">      
                    <div class="card card-primary">
                        <!-- form start -->
                        <form action="{{ route('ageframe.update', $ageframe) }}" method="POST">
                        @csrf
                        @method('PUT')
                        <div class="card-body">
                          <div class="form-group">
                            <label for="InputUrl">URL</label>
                            <input id="InputUrl" value="{{ $ageframe['url'] }}" maxlength="250" class="form-control" type="text" name="url" placeholder="Введите url" required>
                          </div>
                          <div class="form-group">
                            <label for="InputTitle">Title</label>
                            <input id="InputTitle" value="{{ $ageframe['title'] }}" maxlength="250" class="form-control" type="text" name="title" placeholder="Введите title" required>
                          </div>
                          <div class="form-group">
                            <label for="InputDescription">Description</label>
                            <input id="InputDescription" value="{{ $ageframe['description'] }}" maxlength="250" class="form-control" type="text" name="description" placeholder="Введите Description" required>
                          </div>
                          <div class="form-group">
                            <label for="InputH1">H1</label>
                            <input id="InputH1" value="{{ $ageframe['h1'] }}" maxlength="250" class="form-control" type="text" name="h1" placeholder="Введите загаловок H1" required>
                          </div>
                          <div class="form-group">
                            <label for="InputSubtitle">Текст под заголовком</label>
                            <input id="InputSubtitle" value="{{ $ageframe['subtitle'] }}" maxlength="250" class="form-control" type="text" name="subtitle" placeholder="Введите загаловок текст под заголовком" required>
                          </div>
                          <div class="form-group">
                            <label for="InputName">Название поколения</label>
                            <input type="text" value="{{ $ageframe['name'] }}" maxlength="250" name="name" id="InputName" class="form-control" placeholder="Введите отображаемое название поколения" required>
                          </div>
                          <div class="form-group">
                            <label>Модель</label>
                            <select name="model_id" class="form-control" required>
                                @foreach ($car_models as $car_model)
                                    ...
                                    @if($ageframe['model_id'] == $car_model['id']) selected @endif>{{ DB::table('brands_frames')->where('id', DB::table('car_models_frames')->where('id', $car_model['id'])->value('brand_id') )->value('name') }} {{ $car_model['name'] }}</option>
                                @endforeach
                            </select>
                          </div>
                          <div class="form-group">
                            <label for="feature_image">Картинка</label>
                            <img src="{{url('/')}}/{{$ageframe['img']}}" alt="" class="img-uploaded" style="display: block; max-height: 250px; width: auto; margin: 10px">
                            <input type="text" name="img" class="form-control" id="feature_image" value="{{ $ageframe['img'] }}" readonly required>
                        ...
                        <div class="form-group">
                          ...
                          <textarea name="options[1][parameter1][value]" class="editor">{{ $ageframe['options']['1']['parameter1']['value'] }}</textarea>
                        </div>
                        <!-- parameter 2-->
                        <div class="form-group">
                          ...
                          <textarea name="options[2][parameter2][value]" class="editor">{{ $ageframe['options']['2']['parameter2']['value'] }}</textarea>
                        </div>
                        <!-- parameter 3-->
                        <div class="form-group">
                          ...
                          <textarea name="options[3][parameter3][value]" class="editor">{{ $ageframe['options']['3']['parameter3']['value'] }}</textarea>
                        </div>
                        <!-- parameter 4-->
                        <div class="form-group">
                          ...
                          <textarea name="options[4][parameter4][value]" class="editor">{{ $ageframe['options']['4']['parameter4']['value'] }}</textarea>
                        </div>
                        <!-- parameter 5-->
                        <div class="form-group">
                          <label>Контент</label>
                          ...
                          <textarea name="options[5][parameter5][value]" class="editor">{{ $ageframe['options']['5']['parameter5']['value'] }}</textarea>
                        </div>
                        <!-- question-list -->
                              ...
                              <div class="border p-3 check-subgroup">
                                  @foreach ($questions as $question)
                                          <div class="form-check">
                                              ...
                                              @if (isset($options['6']['question-list']['value'][$question['id']]))
                                                      checked
                                              @endif/>
