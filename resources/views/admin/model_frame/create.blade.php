...
@section('content')
    ...
    <div class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              <h1 class="m-0">Добавить модель</h1>
            </div><!-- /.col -->
          </div><!-- /.row -->
        </div><!-- /.container-fluid -->
      </div>
            ...
            <div class="row">
                <div class="col-lg-12">      
                    <div class="card card-primary">
                        <!-- form start -->
                        <form action="{{ route('carmodelsframe.store') }}" method="POST">
                        @csrf
                        <div class="card-body">
                          <div class="form-group">
                            <label for="InputUrl">Url</label>
                            <input id="InputUrl" maxlength="250" class="form-control" type="text" name="url" placeholder="Введите title" required>
                          </div>
                          <div class="form-group">
                          ...
                          <div class="form-group">
                            ...
                            <input type="text" maxlength="250" name="name" id="InputName" class="form-control" placeholder="Введите отображаемое название модели" required>
                          </div>
                          <div class="form-group">
                            <label>Марка</label>
